<?php /*a:1:{s:63:"D:\wamp\www\rhaphp-master/addons/redPack/view//index/index.html";i:1537405611;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div style="padding: 0px 10px 0px 10px;">
    当前红包活动总共发出<?php echo htmlentities($record['total_record']); ?>份红包，红包总额为<?php echo htmlentities($record['total_money']); ?>元。
    <a onclick="delRedPack()" class="layui-btn layui-btn-sm layui-btn-normal"> 设为过去活动</a>
    <hr>
    ...
    <table class="layui-table" lay-skin="nob" lay-size="sm">
        ...
        <tr>
            ...
            <td><img src="<?php echo htmlentities($vo['headimgurl']); ?>" style="width: 28px;height: 28px; border-radius: 3px;"></td>
