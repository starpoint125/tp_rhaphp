<?php /*a:2:{s:55:"D:\wamp\www\rhaphp-master\themes/pc/mp/index\addmp.html";i:1537234068;s:64:"D:\wamp\www\rhaphp-master\themes/pc/mp/..\admin\common\base.html";i:1537234068;}*/ ?>
<!DOCTYPE html>
<html>
<head>
            ...
            $.post('',data.field,function (res) {
                if(res.status=='1'){
                    layer.msg(res.msg,{time:1000},function () {
                         window.location.href="<?php echo url('mp/index/mplist'); ?>";
                    });
                }else{
                    layer.msg(res.msg);
                }
