<?php /*a:2:{s:56:"D:\wamp\www\rhaphp-master\themes/pc/mp/member\index.html";i:1537234068;s:64:"D:\wamp\www\rhaphp-master\themes/pc/mp/..\admin\common\base.html";i:1537234068;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
    <ul class="layui-tab-title">
        ...
        <li <?php if($do == 'register'): ?>class="layui-this"<?php endif; ?>><a href="<?php echo url('mp/Member/index',['do'=>'register']); ?>">注册授权</a></li>
    </ul>
    <div class="layui-tab-content">
        <?php switch($do): case "page": ?>
        <blockquote class="site-text layui-elem-quote">
            会员中心地址：<a target="_blank" href="<?php echo htmlentities($memberUrl); ?>"><?php echo htmlentities($memberUrl); ?></a>
        </blockquote>
            <?php break; case "friend": ?>
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td><img src="<?php echo htmlentities($v['headimgurl']); ?>" width="30" height="30"></td>
                        <td><?php echo htmlentities($v['mobile']); ?></td>
                        <td><?php echo htmlentities($v['group_id']); ?></td>
                        <td><?php echo htmlentities($v['score']); ?></td>
                        <td><?php echo htmlentities($v['money']); ?></td>
                        <td><?php echo htmlentities(date("Y-m-d",!is_numeric($v['subscribe_time'])? strtotime($v['subscribe_time']) : $v['subscribe_time'])); ?></td>
                        <td>
                        ...
                        <div class="layui-tab-item layui-show">
                            <table class="layui-table">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo htmlentities($v['group_name']); ?></td>
                                    <td><?php echo htmlentities($v['up_score']); ?></td>
                                    <td><?php echo htmlentities($v['up_money']); ?></td>
                                    <td><?php echo htmlentities($v['discount']); ?>%</td>
                                    ...
                                    <td>
                                            ...
                                            <a href="javascript:;" onclick="delGroup('<?php echo htmlentities($v['gid']); ?>')" class="rha-bt-a">
                                                删除
                                            </a>
                                    </td>
                                </tr>
                ...
                <?php elseif($to == 'updateGroup'): ?>
                    ...
                    <form class="layui-form" action="">
                        <div class="layui-form-item">
                            <label class="layui-form-label">等级名称</label>
                            <div class="layui-input-block">
                                <input type="text" name="group_name" value="<?php echo htmlentities($group['group_name']); ?>" required  lay-verify="required" placeholder="请输入等级名称" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item" style="border-top:1px solid #e2e2e2;border-bottom: 1px solid #e2e2e2">
                            <label class="layui-form-label">升级条件</label>
                            <div class="layui-input-block" style="margin-left: 76px;">
                                <div class="layui-form-item">
                                    <label class="layui-form-label layui-word-aux">累计积分满</label>
                                    <div class="layui-input-inline" style="width: 100px;">
                                        <input type="text" name="up_score" value="<?php echo htmlentities($group['up_score']); ?>" required lay-verify="required" placeholder="请输入密码" autocomplete="off" class="layui-input">
                                    </div>
                                    <div class="layui-form-mid layui-word-aux">分，设置会员等级所需要的累计积分且必须大于等于0</div>
                                </div>
                                <div class="layui-form-item">
                                    <label class="layui-form-label layui-word-aux">消费额度满</label>
                                    <div class="layui-input-inline" style="width: 100px;">
                                        <input type="text" name="up_money" value="<?php echo htmlentities($group['up_money']); ?>" required lay-verify="required" placeholder="请输入密码" autocomplete="off" class="layui-input">
                                    </div>
                                    <div class="layui-form-mid layui-word-aux">元，设置会员等级所需要的消费额度且必须大于等于0</div>
                                </div>
                                <div class="layui-form-item">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <div class="layui-input-inline" style="width: 70px;">
                                    <input type="text"  name="discount" value="<?php echo htmlentities($group['discount']); ?>" required lay-verify="required" placeholder="" autocomplete="off" class="layui-input">
                                </div>
                                <div class="layui-form-mid layui-word-aux">%</div>
                            </div>
                        </div>
                        <div class="layui-form-item layui-form-text">
                            <label class="layui-form-label">描述</label>
                            <div class="layui-input-block">
                                <textarea name="description" placeholder="请输入会员描述" class="layui-textarea"><?php echo htmlentities($group['description']); ?></textarea>
                            </div>
                        </div>
                        <div class="layui-form-item">

                            <div class="layui-input-block">
                                <input type="hidden" name="gid" value="<?php echo htmlentities($group['gid']); ?>">
                                <button class="layui-btn" lay-submit lay-filter="formDemo">立即提交</button>
                                <button type="reset" class="layui-btn layui-btn-primary">重置</button>
                            </div>
                        </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    <div id="login_auto">
                        ...
                        <input  type="radio" <?php if($st['register_type'] == '2'): ?>checked <?php endif; ?> name="register_type" value="2" title="微信授权注册" >
                    </div>
                    <div id="registerType" <?php if($st['register_type'] == '2'): ?> style="display: none" <?php endif; ?> >
                        ...
                        <div class="layui-form-item" style="width: 560px;">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="keyword" placeholder="请输入关键词" value="<?php echo htmlentities($st['keyword']); ?>" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="redirect_url" placeholder="请输入址址"  value="<?php echo htmlentities($st['redirect_url']); ?>" autocomplete="off" class="layui-input">
            ...
            <div class="layui-form-item" style="border-top:1px solid #e2e2e2;border-bottom: 1px solid #e2e2e2">
                ...
                <div class="layui-input-block" style="margin-left: 76px;">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline" style="width: 100px;">
                            <input type="text" name="up_score" value="<?php echo htmlentities($st['up_score']); ?>" required lay-verify="required" placeholder="" autocomplete="off" class="layui-input">
                        </div>
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label layui-word-aux">会员注册送</label>
                        <div class="layui-input-inline" style="width: 100px;">
                            <input type="text" name="up_money" value="<?php echo htmlentities($st['up_money']); ?>" required lay-verify="required" placeholder="" autocomplete="off" class="layui-input">
                        </div>
