<?php /*a:2:{s:64:"D:\wamp\www\rhaphp-master\themes/pc/admin/appstore\register.html";i:1537234068;s:58:"D:\wamp\www\rhaphp-master\themes/pc/admin/common\base.html";i:1537234068;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="rhaphp-srivice-register">
    <form class="layui-form layui-form-pane" action="" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="domain" required lay-verify="required" value="<?php echo htmlentities($domain); ?>" placeholder="请输入域名" autocomplete="off" class="layui-input">
                <p class="tip_for_p">注：请你认真并正确填写你的域名，系统默认你当前域名。如:https://www.rhaphp.com </p>
            </div>
        </div>
        <div class="layui-form-item">
...
<script>
    layui.use('form', function () {
        ...
        $('#getMobileCode').click(function(){
            var myregs = /^(((13[0-9]{1})|(15[0-9]{1})|(18[0-9]{1}))+\d{8})$/;
            if(!myregs.test($("#phone").val())) {
