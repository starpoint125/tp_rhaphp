<?php /*a:2:{s:65:"D:\wamp\www\rhaphp-master\themes/pc/admin/system\adminmember.html";i:1537234068;s:58:"D:\wamp\www\rhaphp-master\themes/pc/admin/common\base.html";i:1537234068;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<a href="<?php echo url('addAdminMember'); ?>"  class="layui-btn layui-btn-normal layui-btn-sm rha-nav-title">增加成员</a>
</h2>
        </div>
        <?php endif; ?>
...
<table class="layui-table" lay-even="" lay-skin="nob">
    ...
    <tr>
        ...
        <td>
            <?php if($vo['status'] == '1'): ?>
            <a class="rha-bt-a" onclick="disabledAdmin('<?php echo htmlentities($vo['id']); ?>','0')" href="javascript:;">禁用</a>
            <?php else: ?><a class="rha-bt-a" onclick="disabledAdmin('<?php echo htmlentities($vo['id']); ?>','1')" href="javascript:;">开启</a><?php endif; ?>
